      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-5 lg:gap-10">
          <motion.div
            ...
            className="glass glow-hover lg:col-span-3 rounded-2xl p-8 md:p-10"
          >
              ...
              {aboutParagraphs.map((paragraph, i) => (
                <motion.p
                  ...
                  className={`text-[15px] leading-[1.85] tracking-[0.01em] text-muted/95 md:text-base md:leading-[1.9] ${
                    i === 0
                      ? "text-[17px] font-medium leading-[1.75] text-text/95 md:text-lg"
                      : ""
                  }`}
                >
                  {paragraph}
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            {highlights.map(({ icon: Icon, title, desc }, i) => (
              ...
              >
                ...
                <h3 className="mb-1.5 font-semibold tracking-tight text-text">
                  {title}
                </h3>
